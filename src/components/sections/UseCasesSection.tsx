    ...
    <section id="objetivos" className="bg-muted/30 py-20 md:py-32">
      <div className="container mx-auto px-4">
        <ScrollReveal className="mb-16 text-center max-w-4xl mx-auto">
          ...
          <h2 className="section-title text-3xl font-bold md:text-5xl text-[#4A2B1D] mb-6 leading-tight">
            Projetos Ideais para <br />
            <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent italic">Diferentes Objetivos</span>
          </h2>
          <p className="mx-auto max-w-2xl text-base text-muted-foreground md:text-lg lg:text-xl mt-4">
            Nossos <strong className="text-foreground">chalés de madeira</strong> e <strong className="text-foreground">casas pré-fabricadas</strong> são projetados para máxima versatilidade e retorno.
          </p>
        </ScrollReveal>
