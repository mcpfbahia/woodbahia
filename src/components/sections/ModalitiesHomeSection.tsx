  ...
  const cards = [
    {
      ...
      icon: Package,
      description: "Receba exclusivamente o madeiramento estrutural em Pinus autoclave com manual e suporte por vídeo.",
      features: [
        "Apenas madeira Pinus (vigas, assoalho, forro, etc.)",
        "Manual técnico detalhado de montagem",
        "Suporte técnico em tempo real por vídeo",
