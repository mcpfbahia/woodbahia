...
const FAQItem = ({
  ...
  >
    <button
      onClick={onClick}
      className={`flex w-full items-start gap-3 rounded-xl border border-border p-4 text-left transition-all duration-300 md:gap-4 md:rounded-xl md:p-5 lg:p-6 ${
        isOpen
      ...
      <div className="container mx-auto px-4">
        <ScrollReveal className="text-center mb-16">
          ...
          <h2 className="section-title text-3xl font-bold md:text-5xl text-[#4A2B1D] mb-6 tracking-tight">
            Perguntas e <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent italic">Respostas</span>
          </h2>
          <p className="mx-auto max-w-2xl text-base text-muted-foreground md:text-lg lg:text-xl mt-4">
            Encontre respostas para as principais dúvidas sobre nossos <strong className="text-foreground">chalés de madeira</strong> e <strong className="text-foreground">casas pré-fabricadas</strong>.
          </p>
        </ScrollReveal>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <ScrollReveal delay={0.2}>
            <div className="mt-8 rounded-xl border border-border bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 p-4 text-center md:mt-12 md:rounded-xl md:p-6 lg:p-8">
